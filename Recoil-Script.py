...
def pull_down(active_weapon):
    ...
    if active_weapon == 1:
        while current_bullet < len(Recoil_Ak47) and win32api.GetKeyState(0x01) < 0:
            ...
            mouse_move(((Recoil_Ak47[current_bullet][0] / 2) / userSens), ((Recoil_Ak47[current_bullet][1] / 2) / userSens))
            time.sleep(ak_delay/ 1000)
            current_bullet += 1
    elif active_weapon == 2:
        while current_bullet < len(Recoil_Lr300) and win32api.GetKeyState(0x01) < 0:
            mouse_move(((Recoil_Lr300[current_bullet][0] / 2) / userSens), ((Recoil_Lr300[current_bullet][1] / 2) / userSens))
            time.sleep(lr_delay / 1000)
            current_bullet += 1
    elif active_weapon == 3:
        while current_bullet < len(Recoil_Mp5a4) and win32api.GetKeyState(0x01) < 0:
            mouse_move(((Recoil_Mp5a4[current_bullet][0] / 2) / userSens), ((Recoil_Mp5a4[current_bullet][1] / 2) / userSens))
