...
lyrics = ["Two to the one from the one to the three", "I'm a menace, a dentist, an oral hygienist", "I'm lookin' for a girl I can fuck in my hummer truck", "OFF THE JUICE CODEINE GOT ME TRIPPIN", "Must be a circus in town, let's shut that shit down", "Let's get down to business, what is this"]

engine.say(lyrics[random.randint(0, (len(lyrics) - 1))])
engine.runAndWait()
