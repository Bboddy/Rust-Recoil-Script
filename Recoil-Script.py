...
########### Recoil Tables
perfect_AK = [(324, 412), (329, 460), (272, 503), (228, 542), (228, 576), (245, 605), (275, 630), (314, 650), (358, 665), (402, 675), (441, 685), (472, 704), (490, 730), (490, 761), (475, 795), (447, 829), (409, 862), (364, 892), (316, 917), (269, 935), (226, 943), (190, 948), (165, 962), (154, 983), (166, 1009), (203, 1038), (253, 1067), (304, 1094), (343, 1116)]
...
def control(recoil_pattern, weapon_delay, crouch_matters = False):
    smoothing_value = random.randrange(4, 12, 2)
    current_bullet = 0
    if crouch_matters:
        ...
        while current_bullet < len(recoil_pattern) and win32api.GetKeyState(0x01) < 0:
            recoil_x = (((recoil_pattern[current_bullet][0] / 2) / userSens) * active_scope_value) #+ random.uniform(0, 0.69)
            recoil_y = (((recoil_pattern[current_bullet][1] / 2) / userSens) * active_scope_value) #+ random.uniform(0, 0.69)
            move_x = round(recoil_x / smoothing_value)
            move_y = round(recoil_y / smoothing_value)
            for i in range(smoothing_value):
                if win32api.GetKeyState(0x01) < 0:
                    mouse_move(move_x, move_y)
            mouse_move((recoil_x - (move_x * smoothing_value)), (recoil_y - (move_y * smoothing_value)))
            time.sleep(weapon_delay/ 1000)
            current_bullet += 1
    return
